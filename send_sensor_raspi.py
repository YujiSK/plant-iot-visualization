#!/usr/bin/env python3
"""Read the sensors connected to the primary Raspberry Pi.
...
LOCATION_ID = os.getenv("LOCATION_ID", "location-a")
...
def read_sensor_payload(dht, spi):
    ...
    data = {
        ...
        "humidity": humidity,
        "pressure": None,
        "source": "raspi-dht11-ds18b20-mcp3208",
        "device_id": DEVICE_ID,
